...
import Dashboard from "./components/adminpages/workpages/Dashboard";
import EmpDashboard from "./components/employeepages/empworkpages/EmpDashboard";
  ...
  return (
    <Routes>
      ...
      <Route path="/dashboard" element={<SideNav />}>
        <Route path="/dashboard/admindashboard" element={<Dashboard />} />
      ...
      <Route path="employee/dashboard" element={<SideNavEmp />}>
        ...
        <Route path="/employee/dashboard/EmpDashboard" element={<EmpDashboard />} />
        <Route
